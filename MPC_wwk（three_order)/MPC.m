...
while idx < length(ref_x)-1
    ...
    % 调用MPC控制器
    [U,idx,latError,du_k_1_1 ] = mpc_control(x, y, fai, v, w, ref_x, ref_y, ref_fai, ref_v, ref_w, T, NC, NP,du_k_1) ;
    du_k_1=du_k_1_1;
    % 误差太大，退出程序
%     if abs(latError) > 3
%         disp('误差过大，退出程序!\n')
...
%     end
    ...
    % 更新状态量
    [x, y, fai, v, w] = updateState(x, y, fai, v, w, ref_x, ref_y, ref_fai, ref_v, ref_w, T, U,idx); 
